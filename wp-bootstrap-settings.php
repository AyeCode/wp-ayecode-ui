...
if ( ! class_exists( 'WP_Bootstrap_Settings' ) ) {
	...
	class WP_Bootstrap_Settings {
		...
		public function enqueue_style() {
			...
			if($this->settings['css']=='core-helpers'){
				...
				wp_enqueue_style( 'bootstrap-helpers' );
			}
		}
		...
		public function get_settings() {
			...
			$defaults = array(
				'css'       => 'core-helpers', // css to load, core-helpers, helpers
			...
			<div class="wrap">
				...
				<form method="post" action="options.php">
					...
					<table class="form-table wpbs-table-settings">
						<tr valign="top">
							<th scope="row"><label
									for="wpbs-css"><?php _e( 'Load CSS', 'bootstrap-settings' ); ?></label></th>
							<td>
								<select name="wp-bootstrap-settings[css]" id="wpbs-css">
									<option	value="core-helpers" <?php selected( $this->settings['css'], 'core-helpers' ); ?>><?php _e( 'Core + Helpers (default)', 'bootstrap-settings' ); ?></option>
									<option value="helpers" <?php selected( $this->settings['css'], 'helpers' ); ?>><?php _e( 'Helpers', 'bootstrap-settings' ); ?></option>
									<option	value="" <?php selected( $this->settings['css'], '' ); ?>><?php _e( 'Disabled', 'bootstrap-settings' ); ?></option>
								</select>
							</td>
						</tr>
						...
						<tr valign="top">
							<th scope="row"><label
									for="wpbs-js"><?php _e( 'Load JS', 'bootstrap-settings' ); ?></label></th>
							<td>
								<select name="wp-bootstrap-settings[js]" id="wpbs-js">
									<option	value="core-helpers" <?php selected( $this->settings['js'], 'core-popper' ); ?>><?php _e( 'Core + Popper (default)', 'bootstrap-settings' ); ?></option>
									<option value="popper" <?php selected( $this->settings['js'], 'popper' ); ?>><?php _e( 'Popper', 'bootstrap-settings' ); ?></option>
									<option	value="" <?php selected( $this->settings['js'], '' ); ?>><?php _e( 'Disabled', 'bootstrap-settings' ); ?></option>
								</select>
							</td>
						</tr>
